...
export function InputPassword(props) {
    ...
    return (
        <div className='input' id="pass-input">
            <input className='cajon-input-pass' name={props.name} value={props.value} onChange={props.onChange} placeholder={props.placeholder} type={showPwd ? "text" : "password"} id={props.id}>
